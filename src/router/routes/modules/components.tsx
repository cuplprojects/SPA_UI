...
import Test from '@/pages/sys/error/Test';
...
const IconPage = lazy(() => import('@/pages/components/icon/IconPage'));
const UploadPage = lazy(() => import('@/pages/components/upload'));
const ChartPage = lazy(() => import('@/pages/components/chart'));
const ProfilePage = lazy(() => import('@/pages/components/profile/Profile'));
const Testcomp = lazy(() => import('@/pages/components/testcomponent/Testcomp'));
...
const components: AppRouteObject = {
  ...
  children: [
    ...
    },
    {
      path: 'test',
      element: <Test />,
      meta: { label: 'Test', key: '/components/test' },
    },
    {
      path: 'i18n',
    ...
    },
    {
      path: 'profile',
      element: <ProfilePage />,
      meta: { label: 'sys.menu.profile', key: '/components/profile' },
    },
    {
      path: 'testcomponent',
      element: <Testcomp />,
      meta: { label: 'sys.menu.profile', key: '/components/testcomponent' },
    },
  ],
};
